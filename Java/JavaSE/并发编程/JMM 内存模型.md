...
Java 是多线程语言，但多线程带来的最大坑就是 **内存可见性问题**。

不同 CPU 核心有自己的缓存，线程在执行时不一定直接读写主内存（RAM），而是先操作寄存器或 CPU 缓存。这样就会出现：

- **线程 A** 改了一个变量，但 **线程 B** 可能看不到最新的值（因为 B 还在读旧缓存）。
- 指令可能被 **编译器 / CPU 重排序**，导致执行顺序和代码写法不一样。
## 指令重排序
...
[来源](https://github.com/TangBean/Java-Concurrency-in-Practice/blob/master/Ch0-Java%E5%B9%B6%E5%8F%91%E7%BC%96%E7%A8%8B%E5%9F%BA%E7%A1%80/00-Java%E5%86%85%E5%AD%98%E6%A8%A1%E5%9E%8B.md#java-%E5%86%85%E5%AD%98%E6%A8%A1%E5%9E%8B%E4%B8%AD%E7%9A%84-8-%E4%B8%AA%E5%8E%9F%E5%AD%90%E6%93%8D%E4%BD%9C)
