...
> [9. 垃圾回收器 | Golang |《Go面试系列》| Go 技术论坛 (learnku.com)](https://learnku.com/docs/go-interviews/9-la-ji-hui-shou-qi/16576)
## 垃圾回收概念
...
## go的垃圾回收
golang实现的垃圾收集比较轻量，只使用了标记清理，不对内存进行复制和整理，也没有垃圾分代的收集理论
